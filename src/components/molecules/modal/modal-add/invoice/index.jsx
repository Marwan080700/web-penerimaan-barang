...
import { addInvoices } from "../../../../../redux/slice/invoice";
import { getSale, getSales, salesSelectors } from "../../../../../redux/slice/sales";
...
const ModalAddDataInvoice = ({
  ...
  // console.log("selectedSale?.total_amount", selectedSale?.total_amount)
  ...
  const handleAddInvoice = async (e) => {
    ...
    formData.set("no_faktur_pajak_pengganti", formValueInvoice?.no_faktur_pajak_pengganti);
    ...
    await dispatch(addInvoices({ formData, config })).then(() => {
  ...
  if (!isOpenAddInvoices) return null;
