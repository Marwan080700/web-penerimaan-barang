...
const ModalConfirmHapusSalesDetail = ({
  handleDeleteSalesDetail,
  toggleOpenDeleteSalesDetail,
  isOpenDeleteSalesDetail,
}) => {
  if (!isOpenDeleteSalesDetail) null;
            ...
            <div className="bg-white p-6 border rounded relative w-[20rem] ">
              ...
              <div className="flex justify-center gap-5">
                ...
                <button
                  type="button"
                  onClick={() => {
                    handleDeleteSalesDetail(), toggleOpenDeleteSalesDetail();
                  }}
...
export default ModalConfirmHapusSalesDetail;
