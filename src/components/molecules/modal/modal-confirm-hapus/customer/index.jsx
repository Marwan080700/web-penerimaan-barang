...
const ModalConfirmHapusCustomer = ({
  isOpenDeleteCustomer,
  toggleOpenDeleteCustomer,
  handleDelete,
}) => {
  if (!isOpenDeleteCustomer) null;
            ...
            <div className="bg-white p-6 border rounded relative w-[20rem] ">
              ...
              <div className="flex justify-center gap-5">
                ...
                <button
                  type="button"
                  onClick={() => {
                    handleDelete(), toggleOpenDeleteCustomer();
                  }}
...
export default ModalConfirmHapusCustomer;
